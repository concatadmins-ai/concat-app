        ...
        >
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: "clamp(18px, 2.2vw, 24px)", color: "rgba(255,255,255,0.7)", lineHeight: 1.6, margin: "0 auto", maxWidth: 800 }}>
              This is not a marketplace filled with interchangeable products. It is a collection of brands with individual character. We believe the best brands are more than the products they sell—they have their own creative vision, values, and story.
            </p>
          </div>

          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 32 }}>
             <div className="glass-card" style={{ padding: "50px 40px", borderRadius: 32, background: "linear-gradient(135deg, rgba(74,14,23,0.15) 0%, rgba(17,17,17,1) 100%)" }}>
               <h3 style={{ fontSize: 28, fontWeight: 900, color: "#FFF", marginBottom: 20 }}>Brand Philosophy</h3>
               <p style={{ fontSize: 18, color: "rgba(255,255,255,0.65)", lineHeight: 1.6, margin: 0 }}>
                 We believe quality should always be easy to discover. Today’s marketplaces often prioritize volume, discounts, and advertising spend. We believe customers deserve a better experience—one where every brand has earned its place through the quality of its products and the values it represents. Our goal is not to build the largest marketplace. Our goal is to build the most respected one.
               </p>
             </div>
          </div>
        </motion.div>
      ...
      <section style={{ padding: "120px 24px", boxSizing: "border-box", display: "flex", justifyContent: "center", position: "relative", zIndex: 10 }}>
        ...
        >
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: "clamp(18px, 2.2vw, 24px)", color: "rgba(255,255,255,0.7)", lineHeight: 1.6, margin: "0 auto", maxWidth: 800 }}>
              CONCAT isn't a flat marketplace. It's a curated ecosystem where independent brands maintain their distinct identities—like a well-run, multi-brand department store for the digital age. 
            </p>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: 32 }}>
            <div className="glass-card" style={{ padding: "50px 40px", borderRadius: 32, background: "linear-gradient(135deg, rgba(74,14,23,0.15) 0%, rgba(17,17,17,1) 100%)", borderColor: "rgba(226,164,174,0.2)" }}>
              ...
              <p style={{ fontSize: 18, color: "rgba(255,255,255,0.65)", lineHeight: 1.6, margin: 0 }}>
                Every brand on CONCAT is evaluated on product quality, craftsmanship, brand identity, customer experience, and authenticity. We ensure you get something well-made, well-designed, and worth keeping—without the luxury markup. Being featured represents trust and credibility.
              </p>
            </div>
            ...
            <div className="glass-card" style={{ padding: "50px 40px", borderRadius: 32 }}>
              ...
              <p style={{ fontSize: 18, color: "rgba(255,255,255,0.65)", lineHeight: 1.6, margin: 0 }}>
                Our LLM-powered styling assistant provides hyper-personalized recommendations based on your existing wardrobe. Discovering, styling, and buying feel like one connected experience. We provide the platform and discovery, while brands retain full control of their distinct storefronts.
              </p>
            </div>
          </div>
        </motion.div>
