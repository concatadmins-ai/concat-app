...
export default function AboutUs() {
  ...
  return (
    <div ref={containerRef} className="page-scroll" style={{ background: "#050505", height: "100vh", overflowY: "auto", overflowX: "hidden", color: "#FFFFFF" }}>
      <Navbar />

      {/* BACKGROUND TEXTURE */}
      <div className="screen-texture" style={{ opacity: 0.15 }} />
      ...
      <section style={{ 
        ...
        />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, transparent 40%, #050505 100%)", zIndex: 1 }} />
      ...
      {/* SECTION 2: MARQUEE */}
      <div style={{ width: "100%", overflow: "hidden", background: BURG, padding: "20px 0", borderTop: "2px solid #FFF", borderBottom: "2px solid #FFF", position: "relative", zIndex: 20 }}>
        <motion.div 
          animate={{ x: ["0%", "-50%"] }}
        ...
        >
          {Array(10).fill("NO MASS PRODUCTION // ONLY EXCEPTIONAL BRANDS // ").map((text, i) => (
            <span key={i} style={{ fontSize: 24, fontWeight: 900, letterSpacing: 2, color: "#000", paddingRight: 40 }}>
              {text}
            </span>
          ))}
        </motion.div>
      ...
      <section style={{ padding: "120px 24px", boxSizing: "border-box", position: "relative", zIndex: 10 }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 40, alignItems: "center" }}>
          ...
          >
            ...
            <p style={{ fontSize: 18, color: "rgba(255,255,255,0.7)", lineHeight: 1.6, marginBottom: 40, maxWidth: 500 }}>
            ...
            <Link href="/shop" style={{
              display: "inline-block", padding: "16px 32px", background: "#FFF", color: "#000",
            ...
            onMouseEnter={(e) => { e.currentTarget.style.background = BURG; e.currentTarget.style.color = "#FFF"; }}
          ...
          >
            <img src="/media__1784132886336.png" alt="Streetwear Look" style={{ position: "absolute", top: 0, right: "10%", width: "70%", height: "60%", objectFit: "cover", zIndex: 2, border: "2px solid #FFF", boxShadow: "20px 20px 0px rgba(74,14,23,1)" }} />
            <img src="/accessories_1784145426818.png" alt="Accessory Look" style={{ position: "absolute", bottom: 0, left: 0, width: "60%", height: "50%", objectFit: "cover", zIndex: 3, border: "2px solid #FFF" }} />
            <div style={{ position: "absolute", top: "45%", left: "50%", transform: "translate(-50%, -50%)", fontSize: "140px", fontWeight: 900, color: "transparent", WebkitTextStroke: "2px rgba(255,255,255,0.1)", zIndex: 1, pointerEvents: "none" }}>
              RAW.
            </div>
          </motion.div>
      ...
      <section style={{ padding: "120px 24px", background: "#000", boxSizing: "border-box", position: "relative", zIndex: 10, borderTop: "1px solid rgba(255,255,255,0.1)" }}>
        <motion.div
        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 32, textAlign: "left" }}>
            <div style={{ background: "#0A0A0A", padding: 40, border: "1px solid rgba(255,255,255,0.1)" }}>
      ...
      {/* FOOTER */}
      <footer style={{ padding: "80px 24px", textAlign: "center", borderTop: "1px solid rgba(255,255,255,0.05)", position: "relative", zIndex: 10, background: "#050505" }}>
        <div style={{ fontFamily: "inherit", fontSize: "clamp(50px, 10vw, 120px)", fontWeight: 900, color: "#111", letterSpacing: -4, lineHeight: 0.8 }}>
          concat.
        </div>
        <div style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", marginTop: 24, letterSpacing: 2, textTransform: "uppercase" }}>
